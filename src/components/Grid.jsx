...
export default function Grid(props) {
  ...
  var onOpenIdeas = props.onOpenIdeas
  var onOpenStickies = props.onOpenStickies
  ...
  var addFolderBtn = editMode ? React.createElement('div', {
    ...
    React.createElement('div', { style: { fontSize: 13, fontWeight: 700, letterSpacing: '0.04em', textTransform: 'uppercase', color: 'inherit' } }, 'Dossier')
  ) : null
  ...
  var addBtn = React.createElement('div', {
    ...
    React.createElement('div', { style: { fontSize: 13, fontWeight: 700, letterSpacing: '0.04em', textTransform: 'uppercase', color: 'inherit' } }, 'Ajouter')
  )
  ...
  return React.createElement('div', null,
    ...
    editMode ? React.createElement('p', { style: { fontSize: 11, color: '#555', marginBottom: 14, letterSpacing: '0.05em' } }, 'Glisser pour reordonner · Deposer sur un dossier pour y ajouter') : null,
    React.createElement('div', { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(120px, 1fr))', gap: 12 } },
      elements, stickiesBtn, ideasBtn, toolsBtn, addFolderBtn, addBtn
    )
  )
}
